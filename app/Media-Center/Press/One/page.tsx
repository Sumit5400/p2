                ...
                <div className="container p-4 mt-4">
                    <div className="row">
                        <div className="col-lg-8">
                            <img src="https://www.aclnepal.com/np/wp-content/uploads/2024/01/construction-expert.png" alt="" />
                            <h3 className='text-primary pt-4'>Construction Expert Interaction Program organized by Argakhanchi Cement.</h3>
                        ...
                        <div className="col-lg-4 p-1 ps-4">
                            ...
                            <div className="row p-4 border-bottom pb-1">
                                <div className="col-lg-5">
                                    <Link href="/Media-Center/Press/Four">
                                        <img className='w-100 hover-opacity' src="https://www.aclnepal.com/np/wp-content/uploads/2024/01/43grade.png" alt="" />
                                    </Link>
                                </div>
                                <div className="col-lg-7 small-box">
                                    <Link className='text-primary' href="/Media-Center/Press/Four">Arghakhanchi OPC Cement Now Available In 43 Grade</Link>
                                    <p className='pt-1'>10 Jan 2024</p>
                                </div>
                            </div>
                            {/* End Slide */}
