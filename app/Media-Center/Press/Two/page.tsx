                ...
                <div className="container p-4 mt-4">
                    <div className="row">
                        <div className="col-lg-8">
                            <img src="https://www.aclnepal.com/np/wp-content/uploads/2023/12/5.png" alt="" />
                            <h3 className='text-primary pt-4'>Arghakhanchi Cement has started exporting its products to India.</h3>
                        ...
                        <div className="col-lg-4 p-1 ps-4">
                            ...
                            <div className="row p-4 border-bottom pb-1">
                                ...
                                <div className="col-lg-7 small-box">
                                    <Link className='text-primary' href="">Arghakhanchi Cement has started exporting its products to India.</Link>
